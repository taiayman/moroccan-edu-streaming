...
const TimeTable = () => {
  ...
  const timeSlots = {
    '19h-20h': {
      ...
      'Vendredi': { subject: 'Histoire géo', type: 'Bac L' },
      'Samedi': { subject: 'Pc', type: 'Bac S' },
      'Dimanche': { subject: 'Svt', type: 'Bac S' },
    },
    '20h-21h': {
      'Lundi': { subject: 'Anglais', type: 'Bac S/L' },
      'mardi': { subject: 'Eco', type: 'Bac SE' },
      'Mercredi': { subject: 'Arabe', type: 'Bac L' },
      'Jeudi': { subject: 'Eco', type: 'Bac SE' },
      'Vendredi': { subject: 'Svt', type: 'Bac S' },
      'Samedi': { subject: 'Histoire géo', type: 'Bac L' },
      'Dimanche': { subject: 'Maths', type: 'Bac S' },
    },
    '14h-15h': {
      'Lundi': { subject: '', type: '' },
      'mardi': { subject: '', type: '' },
      ...
      'Dimanche': { subject: 'Français', type: 'Bac L' },
    },
    '15h-16h': {
      'Lundi': { subject: '', type: '' },
      'mardi': { subject: '', type: '' },
